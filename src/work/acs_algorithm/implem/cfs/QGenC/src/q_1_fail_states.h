...
typedef struct {
   ...
   /* Output from Step/ACS_Algorithm/If Fail Recalculate/1 Fail/Selector/OutDataPort1 */

   GABOOL Selector1_out1;
   /* Output from Step/ACS_Algorithm/If Fail Recalculate/1 Fail/Selector1/OutDataPort1 */

   GABOOL Selector2_out1;
   /* Output from Step/ACS_Algorithm/If Fail Recalculate/1 Fail/Selector2/OutDataPort1 */
